...
[![Release](https://img.shields.io/badge/release-v0.9.13-brightgreen.svg)](https://github.com/HenZenKuriRIP/XrayR4u/releases)
...
```bash
# 示例：linux amd64
curl -sSL -o XrayR https://github.com/HenZenKuriRIP/XrayR4u/releases/download/v0.9.13/XrayR-linux-amd64
chmod +x XrayR
